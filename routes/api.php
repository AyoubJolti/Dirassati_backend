...
use App\Http\Controllers\GroupEtudiantController;
...
Route::get('Group/getGroupeEtudiant/{id}',[GroupeController::class,'getGroupeEtudiant']);
...
///Emploi
Route::get('getAllEmploiData',[EmploiController::class,'getAllEmploiData']);
...
Route::get('getAllEmploi',[EmploiController::class,'index']);
Route::post('addEmploi', [EmploiController::class, 'store']);
Route::get('showEmploi/{id}',[EmploiController::class,'show']);
Route::delete('deleteEmploi/{id}',[EmploiController::class,'destroy']);
Route::put('updateEmploi/{id}',[EmploiController::class,'update']);
Route::get('getEmploiData/{id}',[EmploiController::class,'getEmploiData']);
